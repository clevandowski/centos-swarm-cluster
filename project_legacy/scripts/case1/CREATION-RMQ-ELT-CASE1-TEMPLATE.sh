...
then
  ...
  echo "permissionWrite : ${permissionWrite}"
  echo "permissionRead : ${permissionRead}"
  ...
  echo "permissionWriteConcat : ${permissionWriteConcat}"
  echo "permissionReadConcat : ${permissionReadConcat}"
  # update permissions
...
echo "---------------------------------------"
echo "Configuration case 1 succeed"
